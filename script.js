//when I enter the password I want it to be 8-128 characters long
//if the psswrd is btwn 8-128 generate psswrd
//if less than 8 or greater than 128 reject input/prompt too short or too long
...
const generatePassword = () => {
  ...
  if (psswrdLength >= 8 && psswrdLength <= 128) {
    console.log("confirmChoices");
  } else {
    alert("Pick a better length");
    return;
  }
